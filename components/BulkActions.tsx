...
// Two buttons: Mark All Done + Clear Completed
  ...
  return (
    <View className="flex-row mx-4 mb-3 gap-2">
      ...
      >
        ...
        <Text className="text-green-600 text-xs font-semibold ml-1">Mark All Done</Text>
      </TouchableOpacity>
      ...
      >
        ...
        <Text className="text-red-400 text-xs font-semibold ml-1">Clear Completed</Text>
      </TouchableOpacity>
